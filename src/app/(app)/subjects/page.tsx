...
export default async function SubjectsPage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: t.nav.dashboard, href: "/dashboard" }, { label: t.nav.subjects }]} />
      ...
      {list.length === 0 ? (
        <EmptyState title={t.subjects.noSubjectsYet} description={t.subjects.noSubjectsYetBody} />
      ) : (
          ...
          {list.map((s) => (
            ...
            >
              ...
              <form action={deleteSubjectAction}>
                ...
                <ConfirmButton
                  message={format(t.subjects.confirmRemoveSubject, { name: s.name })}
